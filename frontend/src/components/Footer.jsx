...
export default function Footer() {
  ...
  const quickLinks = [
    ...
    { name: "TwinsCloud Lucknow Office", href: "/lucknow" },
        ...
        <div className={styles.footerGrid}>
          ...
          <div className={`${styles.gridCol} ${styles.brandCol}`}>
            ...
            <p className={styles.brandDescription}>
              TwinsCloud is a Lucknow-based AWS Channel Reseller and premier cloud engineering consulting partner. We deliver software & website development, school ERP systems, robust DevOps workflows, and specialized industry training.
            </p>
          ...
          <div className={`${styles.gridCol} ${styles.newsletterCol}`}>
            ...
            <div className={styles.contactDetails} itemScope itemType="https://schema.org/ProfessionalService">
              <meta itemProp="name" content="TwinsCloud Private Limited" />
              ...
              <p className={styles.contactItem}>
                ...
                <span itemProp="address" itemScope itemType="https://schema.org/PostalAddress" className={styles.interactiveContact} style={{ cursor: "default" }}>
                  <span itemProp="streetAddress">Mubarakpur, Kamalabad Barhauli</span>,{" "}
                  <span itemProp="addressLocality">Lucknow</span>,{" "}
                  <span itemProp="addressRegion">Uttar Pradesh</span>{" "}
                  <span itemProp="postalCode">226201</span>
                </span>
              </p>
              <p className={styles.contactItem}>
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className={styles.contactIcon}>
                ...
                <a href="tel:+919580880060" itemProp="telephone" className={styles.interactiveContact}>+91 95808 80060</a>
              </p>
              <p className={styles.contactItem}>
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className={styles.contactIcon}>
                ...
                <a href="mailto:Support@twinscloud.com" itemProp="email" className={styles.interactiveContact}>Support@twinscloud.com</a>
              </p>
            </div>
          </div>
