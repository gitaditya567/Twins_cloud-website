    ...
    <div className={styles.quickActionsContainer}>
      <div className={styles.capsule}>
        ...
        <div className={styles.actionWrapper} style={{ "--action-index": 1 }}>
          <a href="tel:+919876543210" className={`${styles.actionBtn} ${styles.callBtn}`} aria-label="Call Now">
        ...
        <div className={styles.actionWrapper} style={{ "--action-index": 2 }}>
          <a 
            href="https://wa.me/919876543210?text=Hi%20TwinsCloud,%20I%20have%20an%20inquiry%20regarding%20your%20cloud%20and%20web%20services." 
            target="_blank" 
